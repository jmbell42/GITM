...
subroutine UA_calc_electrodynamics(UAi_nMLTs, UAi_nLats, iBlock)
  ...
  logical :: IsDone, IsFirstTime = .false., DoTestMe, Debug=.False.
...
subroutine UA_calc_electrodynamics_1d(iBlock)
